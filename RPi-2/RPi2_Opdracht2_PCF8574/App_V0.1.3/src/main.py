...
class Main:
    ...
    def _initIO(self):
        ...
        self._btn1GPIO = DigitalInputGPIO(21, GPIO.PUD_DOWN)
        self._btn2GPIO = DigitalInputGPIO(20, GPIO.PUD_DOWN)
        self._btn3GPIO = DigitalInputGPIO(16, GPIO.PUD_DOWN)
        self._btn4GPIO = DigitalInputGPIO(12, GPIO.PUD_DOWN)
        ...
        self._interrupt = DigitalInputGPIO(18, GPIO.PUD_UP)

    def _initCallbacks(self):
        self._btn1GPIO.setEvent(edge=GPIO.RISING, callback=lambda x: self._ledRedPCF8574.toggle(), bouncetime=200)
        self._btn2GPIO.setEvent(edge=GPIO.RISING, callback=lambda x: self._ledGreenPCF8574.toggle(), bouncetime=200)
        self._btn3GPIO.setEvent(edge=GPIO.RISING, callback=lambda x: self._ledBluePCF8574.toggle(), bouncetime=200)
        self._btn4GPIO.setEvent(edge=GPIO.RISING, callback=lambda x: self._ledYellowPCF8574.toggle(), bouncetime=200)

        self._btn1PCF8574.setEvent(callback=lambda : self._ledRedGPIO.toggle())
        self._btn2PCF8574.setEvent(callback=lambda : self._ledGreenGPIO.toggle())
        ...
        self._interrupt.setEvent(edge=GPIO.FALLING, callback=lambda x: self._togglePCFLeds())
